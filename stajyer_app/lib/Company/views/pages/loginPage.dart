...
import 'package:stajyer_app/Company/views/pages/CompanyForgotPassword.dart';
...
class _CompanyLoginPageState extends State<CompanyLoginPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        // Geri tuşuna basıldığında, kullanıcıyı CompanyLoginPage'e yönlendir
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => const LoginPage()),
          (route) => false,
        );
        return false; // Gerçekten geri gitmeye izin verme
      },
      child: Scaffold(
        appBar: AppBar(),
                    ...
                    onPressed: () async {
                      ...
                      if (result != null) {
                        ...
                        if (result.hasSetPassword) {
                          ...
                          showDialog(
                            context: context,
                            builder: (context) => CreatePasswordPopup(
