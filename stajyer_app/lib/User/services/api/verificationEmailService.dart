...
class VerificationService {
  Future<void> sendVerificationCode(String userId) async {
    final url = Uri.parse('http://stajyerapp.runasp.net/api/Application/SendVerificationCode');
  ...
  Future<void> verifyEmail(String userId, String verificationCode) async {
    final url = Uri.parse('http://stajyerapp.runasp.net/api/Application/VerifyEmail');
    final request = VerificationRequest(userId: userId, verificationCode: verificationCode);
