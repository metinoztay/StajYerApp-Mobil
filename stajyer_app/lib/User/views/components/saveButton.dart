...
class SaveButton extends StatefulWidget {
  ...
  const SaveButton(
      {super.key, required this.advertId, required this.ColorSave});
...
class _SaveButtonState extends State<SaveButton> {
  ...
  Future<void> _checkIfAdvertIsSaved() async {
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> savedAdverts =
        prefs.getStringList('savedAdverts_$_userId') ?? [];
    setState(() {
  ...
  Future<void> _toggleSave() async {
    ...
    final model =
        SavingAddDeleteModel(userId: _userId, advertId: widget.advertId);
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> savedAdverts =
        prefs.getStringList('savedAdverts_$_userId') ?? [];
