...
class ApplyButtonService {
  final String baseUrl = 'http://stajyerapp.runasp.net/api/Advert/GetUserIsApplied';

  Future<bool> sendApplyButtonRequest(ApplyButtonModel applyButtonModel) async {
    final url = Uri.parse('$baseUrl/${applyButtonModel.userId}/${applyButtonModel.advertId}');
