...
import 'package:stajyer_app/views/components/basvur.dart';
...
appBar: PreferredSize(
  ...
  child: Container(
    ...
    child: AppBar(
          ...
          Container(
            ...
            child: ClipOval(
              child: FittedBox(
                fit: BoxFit.cover,
                child: Image.network(
                  advert.comp?.compLogo ?? 'https://via.placeholder.com/150',
                  width: 40, // Avatar boyutu
                  height: 40, // Avatar boyutu
                ),
              ),
      ...
      actions: [
        SaveButton(advertId: advert.advertId!.toInt(), ColorSave: ColorsaveBlack,),
